...
public class Get03 {
    ...
    // 1) Tek body() methodu içinde çoklu assertion yaparak "soft assertion" yapabiliriz.
    // Tüm fail durumları hakkında bilgi alabiliriz.

    // 2) Çoklu body() methodları içinde tek assertion yaparak "hard assertion" yaparız.
